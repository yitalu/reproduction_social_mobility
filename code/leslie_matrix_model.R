...
# png(file="./matrix_models/figures/population_over_time.png", width = 1200, height = 800, res = 180)
# pdf(file="./matrix_models/figures/population_over_time.pdf", width = 6, height = 4.3)
# tiff(file="./matrix_models/figures/population_over_time.tiff", width = 2400, height = 1600, res = 300)
...
# png(file="./matrix_models/figures/growth_rate_over_time.png", width = 1200, height = 800, res = 180)
# pdf(file="./matrix_models/figures/growth_rate_over_time.pdf", width = 6, height = 4.3)
# tiff(file="./matrix_models/figures/growth_rate_over_time.tiff", width = 2400, height = 1600, res = 300)
...
plot(growth_rate_instant[, num_class + 1], type = "l", lty="solid", lwd=1, xlab = "Time", ylab = "Growth Rate", main = "Growth Rate over Time", ylim = c(2, 10))
...
legend(6.5, 5.5, legend = c("Total", "Lower Class", "Middle Class", "Upper Class", "Eigenvalue"), lty = c(1:4, 2), lwd = c(1, 1, 1, 1, 1), col = c(rep("black", 4), "red"), cex = 0.8)
# dev.off()
...
# png(file="./matrix_models/figures/proportion_over_time.png", width = 1200, height = 800, res = 180)
# pdf(file="./matrix_models/figures/proportion_over_time.pdf", width = 6, height = 4.3)
# tiff(file="./matrix_models/figures/proportion_over_time.tiff", width = 2400, height = 1600, res = 300)
...
# png(file="./matrix_models/figures/fitness_over_time.png", width = 1200, height = 800, res = 180)
# pdf(file="./matrix_models/figures/fitness_over_time.pdf", width = 6, height = 4.3)
# tiff(file="./matrix_models/figures/fitness_over_time.tiff", width = 2400, height = 1600, res = 300)
ggplot(data, aes(x = time, y = value, fill = group)) + 
  geom_area(alpha = 0.6) + 
